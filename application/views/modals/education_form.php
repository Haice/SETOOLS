<div class="modal fade" id="add_education">
	...
	<div class="modalContainer">
		...
		<?php echo form_open('jobseekers/addEducation'); ?>
			<input type="hidden" name="user_id" value="<?php echo $jobseeker->getId() ?>" />
			School/College/University:<br /><input style="width:550px;" type="text" name="university" /><br /><br />
			Course of Study:<br /><input style="width:550px;" type="text" name="course" /><br /><br />
			...
			<span style="float:right; text-align: right">
			 	Qualification Type: <select name="qualification">
						               	 <option value="">Choose...</option>
			...
			<span class="clear" id="section">Grade: <input type="text" name="grade" /></span>
